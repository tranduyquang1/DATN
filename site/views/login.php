        ...
        <?php if (isset($row) != true) { ?>
            <div class="form-container sign-up-container">
                <form action="?act=dangky" method="post">
                    ...
                    <div class="social-container">
                        ...
                        <a href="https://gmail .com" target="_blank" class="social"><i class="fab fa-google-plus-g"></i></a>
                    </div>
            ...
            <?php if (isset($message) == true) { ?>
                <div class="g_l-mail-px g_l-mail-bg">
                    <form method="post" class="form__glm">
                        <h2 style="margin-bottom: 50px;width: 100%;text-align: center;">Đăng ký thành công</h2>
                        <input type="button" value="Đóng" class="close-modal-notification">
                    </form>
                </div>
                <script>
                    $(function () {
                        $('.close-modal-notification').click(function () {
                            $('.g_l-mail-bg').css('display', 'none');
                            window.location.href = '/site/index.php?ctrl=home&act=dangnhap'
                        })
                    })
                </script>
            <?php } ?>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    ...
                    <div class="overlay-panel overlay-right">
                        <h1>Hello, bạn!</h1>
                        <p>Nếu bạn chưa có tài khoản hãy ấn vào đăng ký nào</p>
