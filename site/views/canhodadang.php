            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p style="margin-top: 20px;"><?php if ($c["amount"]==0) {
                                ?>
                                ...
                                ?>
                                <span class="yesyes" style="background-color: green; padding: 5px; color: white; width: 100%; border-radius: 10px;">Còn <?= $c['amount'] ?> phòng</span>
                                <?php
                            }?></p>
                    </td>
