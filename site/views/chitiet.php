...
<body>
    ...
    <header>
        <div class=" menu1">
            <span class="col-4 right">
                ...
                <a href="#" class="col-6"><i class="fa fa-envelope">thuetro.xyz</i></a>
            </span>
        </div>
        ...
        <div class="item1">
            ...
            <div class="thongtin">
                <div class="tatcatt">
                    ...
                    <div class="btn-tt">
                        ...
                        <label for="" class="label1" style="width: 100px;"><?= $row['ghi_chu'] ?></label>
                ...
                <?php if (isset($_SESSION['cart']) == true) {
                        ...
                        if (isset($_SESSION['cart'][$row['ma_can']]) && $_SESSION['cart'][$row['ma_can']]['ma_can'] == $row['ma_can']) {
            ...
            <div class="gioithieu-tuvan ">
                            ...
                            <div class="col-6 txtx">
                                <ul>
                                    <li class="li1">Hướng: <?php if ($row["huong_nha"] == 1) echo "Đông";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 2) echo "Tây";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 3) echo "Nam";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 4) echo "Bắc";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 5) echo "Tây Bắc";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 6) echo "Tây Nam";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 7) echo "Đông Bắc";
                                                            elseif (isset($c["huong_nha"]) && $c["huong_nha"] == 8) echo "Đông Nam";
                                                            ?></li>
                ...
                <div class="tuvan ">
                    ...
                    <?php if ($row['ghi_chu']== 'Còn phòng'){ ?>
                    <?php if (isset($_SESSION["id"])) {
                    ?>
                        <form action="?ctrl=home&act=datlichxem" method="post" class="form-tuvan" name="myform" onsubmit="return validateform()">
                            <div class="fiel">
                                <input type="hidden" name="ma_can" value="<?= isset($row['ma_can']) ? $row['ma_can'] : '' ?>" id="" style="font-size: 10pt;">
                            </div>
                            <input type="hidden" name="trang_thai_lich" value="1">
                            <div class="fiel">
                                <input type="hidden" name="ma_tk" value="<?= isset($_SESSION['id']) ? $_SESSION['id'] : '' ?>" id="" style="font-size: 10pt;">
                            </div>
                            <div class="fiel">
                                <input type="hidden" name="ngay_dat" value="<?= date("Y-m-d") ?>" id="" style="font-size: 10pt;">
                            </div>
                            <div class="fiel" style="margin-top: 0px;font-size: 10pt;">
                                <input class="ipdl4" id="ten_nguoi_dat" name="ten_nguoi_dat" type="text" placeholder="<?= isset($kh['ho_ten']) ? $kh['ho_ten'] : '' ?>" value="<?= isset($kh['ho_ten']) ? $kh['ho_ten'] : '' ?>" placeholder="Họ tên">
                                <br>
                                <br>
                                <input class="ipdl4" id="sodt" type="text" name="sodt" placeholder="<?= isset($kh['sdt']) ? $kh['sdt'] : '' ?>" value="<?= isset($kh['sdt']) ? $kh['sdt'] : '' ?>" placeholder="Số điện thoại">
                                <br>
                                <br>
                                <input type="datetime-local" min="<?= date("Y-m-d") ?>" name="ngay_xem" id="" style="font-size: 10pt;">
                                <br>
                                <br>
                                <input class="ipdl4" id="ghi_chu" type="text" name="ghi_chu"  placeholder="Ghi Chú" style=" height: 80px;">
                            </div>
                            <div class="fiel-sub">
                        ...
                        <div class="form-tuvan">
                            <div class="fiel">
                                <form action="?ctrl=home&act=datlichxem" method="post" class="form-tuvan" name="myform" onsubmit="return validateform()">
                                    ...
                                    <div class="fiel" style="margin-top: 50px;" style="font-size: 10pt;">
                                        <input class="ipdl4" id="ten_nguoi_dat" name="ten_nguoi_dat" type="text" placeholder="<?= isset($kh['ho_ten']) ? $kh['ho_ten'] : '' ?>" value="<?= isset($kh['ho_ten']) ? $kh['ho_ten'] : '' ?>">
                                        <br>
                                        <br>
                                        <input class="ipdl4" id="sodt" type="text" name="sodt" placeholder="<?= isset($kh['sdt']) ? $kh['sdt'] : '' ?>" value="<?= isset($kh['sdt']) ? $kh['sdt'] : '' ?>">
                                        <br>
                                        <br>
    ...
    <div class="footer">
        ...
        <div class="box4">
            <h4>Đăng ký để biết thêm thông tin từ </h4> <br>
