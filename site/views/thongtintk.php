        ...
        <div class="tt-bg">
            <div class="tt-left">
                ...
                <li><i class="fa fa-bell"></i><a href="?act=thongbao&ma_tk=<?=$_SESSION['id']?>">Thông báo</a></li>
                    ...
                    <li><i class="fas fa-sign-out-alt"></i><a href="?act=dangxuat&logout=1">Đăng xuất tài khoản</a></li>
                </ul>
            </div>
            <div class="tt-right">
            <?php if (isset($rows)) {
                ...
                <form action="?act=thaydoitt" method="post" class="form-tk">
                   ...
                   <div class="tt-right-row">
                       ...
                       <input type="hidden" name="ma_tk" value="<?= isset($kh['ma_tk']) ? $kh['ma_tk'] : '' ?>">
                   </div>
                   <div class="tt-right-row">
                       <label>Email</label>
                       <input type="email" name="email" id=""  value="<?=isset($kh['email']) ? $kh['email'] : ''?>">
                   </div>
                   <div class="tt-right-row">
                       <label>Số điện thoại</label>
                       <input type="text" name="sdt" id=""  value="0<?= isset($kh['sdt']) ? $kh['sdt'] : ''?>">
                   </div>
                    <div class="tt-right-row">
                        <label>Số dư tài khoản </label> <?= isset($kh['currency']) ? number_format($kh['currency'], 0, ' ', '.') : '' ?> VNĐ
                    </div>
