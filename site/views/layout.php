...
<body>
                ...
                <div class="nav-menu2">
                    <ul>
                        ...
                        <?php if (isset($_SESSION['user']) == true) { ?>
                            <?php if(isset($kh) && $kh['vai_tro'] == 1 || $kh['vai_tro'] == 2) { ?>
                                <li><a href="?act=dangtin">Đăng tin</a></li>
                            <?php } ?>
                            <li><a href='?act=thongtintk&ma_tk=<?= $_SESSION['id'] ?>'><?= $_SESSION['user'] ?></a>
                                <ul class="sub-menu">
                                    <?php if(isset($kh) && $kh['vai_tro'] == 1 ) { ?>
                                        <li><a href="http://thuetro.xyz/admin/">Trang Admin</a></li>
                                    <?php } ?>
    ...
    <?php } else { ?>
        <div class="menu">
            ...
            <div class="navtext">
                <h1 style="text-shadow: 2px 2px 2px black; font-family: sans-serif;">TÌM NHÀ TRỌ NHANH SIÊU CẤP</h1>
                <p>Hơn 16.000 nhà riêng , chung cư , nhà trọ cho thuê. Cam kết luôn sẵn sàng <br> cho thuê trong 48 giờ.</p>
            </div>
            <div class="dangky">
                <h3>Đăng ký tìm nhà trọ siêu tốc !</h3>
                ...
                <input type="text" name="notes" placeholder="Nhập thông tin nhà muốn chọn">
            ...
            <div class="dangky2">
                ...
                <div class="text2">
                    <div class="box1">
                        ...
                        <a href="#">Tận tâm</a>
                        <p>Saigonres luôn đồng <br> hành, hỗ trợ mọi vấn <br> đề mọi lúc trong thời <br> gian ngắn nhất.</p>
                    </div>
                    <div class="box1">
                        <div class="icon1">
    ...
    <?php if (isset($view) == true) {
        ...
        <div class="danhsach ">
            ...
            <div class="loc-canho">
                <form action="?ctrl=home&act=timkiemtheogia" method="post">
                    ...
                    <select name="quan" id="" class="select">

                        <?php foreach($quan as $qn) {?>
                            <option value="<?=$qn["ma_quan"]?>"><?=$qn["ten_quan"]?></option>
                        <?php }?>
                    </select>
            ...
            <div class="thuenhatext">
                ...
                <div class="box3">
                    ...
                    <div class="thuenhatext-text">
                        ...
                        <p>Saigonres tìm kiếm nhà thuê theo khu vực và nhu cầu của bạn</p>
                    </div>
                </div>
                <div class="box3">
                    <div class="box-img">
        ...
        <div class="thuenha">
            <div class="tieude3">
                <h2>Khách hàng nói gì về Saigonres ?</h2>
            </div>
