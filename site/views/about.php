...
<body>
    ...
    <div class="thoahiep">
        ...
        <div class="divth1 ">
            <div class="divtext">
                ...
                <p>Saigonreslà một trong những công ty bất động sản nổi tiếng nhất <br>
    ...
    <div class="dichvu">
        <div class="dvtext">
            ...
            <p>Saigonres là một trong những công ty bất động sản nổi tiếng nhất trên khắp nước Mỹ. Bạn có thể tìm <br>
        ...
        <div class="price2">
            <div class="divtext">
                <h1>Chúng tôi luôn mang lại chất lượng
                    <br> tốt nhất </h1>
                <p>Saigonres là một trong những công ty bất động sản nổi tiếng nhất <br>
                    trên khắp nước Mỹ. Bạn có thể tìm thấy tài sản mơ ước của mình <br>
                    hoặc xây dựng tài sản</p>
            </div>
            <div class="divicon">
    ...
    <div class="tuvan">
        <div class="tuvanimg">
            ...
            <div class="tuvantext">
                ...
                <p>Còn rất nhiều nhà riêng, căn hộ, chung cư chưa được đăng lên, hãy để Saigonres tư vấn chọn
                    <br> giúp bạn!</p>
                <div class="tuvan2">
    ...
    <div class="divcuoi">
        <span> 2021 © Bản quyền Saigonres. Đã đăng ký Bản quyền.</span>
    </div>
