...
<body>
    ...
    <div class="conatiner w-100">
        ...
        <div class="dangtin">
            <h3 style="font-family: sans-serif;">ĐĂNG TIN CHO THUÊ</h3>
            <form onsubmit="return validateform()" name="myform" action="?ctrl=home&act=dangtincanho&ma_tk=<?=$_SESSION["id"]?>" class="formdangtin" method="POST" enctype="multipart/form-data">
                <div class="row thongtincan">
                    <h4 class="w-75 ml-5">* Thông tin phòng trọ</h4>
                    <div class="col-6 ml-5">
                        ...
                        <div class="col-3">
                            ...
                            <?php if (isset($_SESSION["id"])) {
                                ...
                                <br>
                                <br>
                                <label style="margin-left: 25px;">Phí đăng</label>(10.000 VND)
                                <?php
                            }
                            else
                            {
                    ...
                    <div class="col-5">
                        ...
                        <div class="col-12">
                            <label for="">Loại phòng thuê</label><br>
                        ...
                        <br>
                            <div class="col-12">
                                ...
                                <br>
                                <div class="row">
                                    <div class="col-6 anh" style="margin-bottom: 50px;">
                                        <input type="file" name="hinh" class="form-control " id="img" style="overflow: hidden; display: none;">
                                        <label for="img" class="w-100 tailen"><img src="../uploaded/uploadhinh.png" style="width: 20%; margin: 0 auto;" alt=""></label>
                                        <div class="hinhanh"><img src="#" alt="" id="loadha" class="loadh1" style="display: none;width: 35%; height: 70px; object-fit: cover;margin-right: 65px;"></div>
                                        <script>
                                    ...
                                    <input type="file" name="hinha" class="form-control " id="img1" style="overflow: hidden; display: none;">
                                        <label for="img1" class="w-100 tailen"><img src="../uploaded/uploadhinh.png" style="width: 20%; margin: 0 auto;" alt=""></label>
                                        <div class="hinhanh"><img src="#" alt="" id="loadha1" class="loadh1" style="display: none;width: 35%; height: 70px; object-fit: cover;margin-right: 65px;"></div>
                                        <script>
                                            // Load hình ảnh lên khi chọn file upload
                                            $(document).ready(function () {
                                                function readURL(input){
                                    ...
                                    <br>
                                    <div class="col-6 mt-5" style="margin-bottom: 50px;">
                                    <input type="file" name="hinhb" class="form-control " id="img2" style="overflow: hidden; display: none;">
                                        <label for="img2" class="w-100 tailen"><img src="../uploaded/uploadhinh.png" style="width: 20%; margin: 0 auto;" alt=""></label>
                                        <div class="hinhanh"><img src="#" alt="" id="loadha2" class="loadh1" style="display: none;width: 35%; height: 70px; object-fit: cover;margin-right: 65px;"></div>
                                        <script>
                                            // Load hình ảnh lên khi chọn file upload
                                            $(document).ready(function () {
                                                function readURL(input){
                                    ...
                                    <input type="file" name="hinhc" class="form-control " id="img3" style="overflow: hidden; display: none;">
                                        <label for="img3" class="w-100 tailen"><img src="../uploaded/uploadhinh.png" style="width: 20%; margin: 0 auto;" alt=""></label>
                                        <div class="hinhanh"><img src="#" alt="" id="loadha3" class="loadh1" style="display: none;width: 35%; height: 70px; object-fit: cover;margin-right: 65px;"></div>
                                        <script>
                                            // Load hình ảnh lên khi chọn file upload
                                            $(document).ready(function () {
                                                function readURL(input){
        ...
        <div class="dichvu">
            ...
            <div class="row dichvunew">
                <div class="sdichvu">
                    <h4>DỊCH VỤ NỔI BẬT CỦA SAIGONRES</h4>
                    <div class="row">
    ...
    <footer class="footer">
        ...
        <div class="box4 b2">
            ...
            <div class="textquan">
                <div class="quan1 l1">
                <?php if (isset($quanallz)) : ?>
                    <?php foreach ($quanallz as $stt =>  $q) {
                        $stt += 1; ?>
